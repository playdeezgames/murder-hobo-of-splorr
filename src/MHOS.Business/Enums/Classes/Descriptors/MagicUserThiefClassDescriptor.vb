Friend Class MagicUserThiefClassDescriptor
    ...
    Public Overrides Function IsQualified(character As ICharacter) As Boolean
        Return character.Dexterity >= 9 AndAlso character.Intelligence >= 9 AndAlso character.Race <> Races.Dwarf AndAlso character.Race <> Races.Halfling AndAlso character.Race <> Races.Man
    End Function
End Class
